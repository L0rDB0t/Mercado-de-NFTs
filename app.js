...
if (typeof window === 'undefined') {
    ...
    try {
      ...
      if (chainId !== SEPOLIA_CONFIG.chainId) {
        try {
          ...
          // Si la red no está agregada en MetaMask
  ...
  async function connectWallet() {
    ...
    try {
      ...
      // Asegúrate que contractAddress y contractABI están definidos
      if (typeof contractAddress === 'undefined' || typeof contractABI === 'undefined') {
        throw new Error("Dirección del contrato o ABI no definidos");
      }
  ...
  // Resto de tus funciones (handleConnectionError, updateWalletUI, etc.) se mantienen igual...
  ...
  async function init() {
    try {
      ...
      if (typeof ethers === 'undefined') {
        showError("La biblioteca ethers.js no está cargada");
        return;
      }
  
      // Verifica si tenemos una conexión existente
      if (window.ethereum) {
